...
local Kobo = Generic:extend{
    ...
    -- Force full screen refresh on resume/startup for clean E Ink rendering
...
local KoboFrost = Kobo:extend{
    ...
    frontlight_settings = {
        ...
        -- Warmth goes from 0 to 10 on BNRV700 (0=cool white, 10=warm amber)
        nl_min = 0,
        nl_max = 10,
        nl_inverted = false,
    },
...
function Kobo:initNetworkManager(NetworkMgr)
    ...
    local net_if = os.getenv("INTERFACE") or "wlan0"
