...
[ -f "${ROOT_DIR}/build/app-switcher" ] && cp "${ROOT_DIR}/build/app-switcher" "${STAGING_DIR}/opt/bin/app-switcher"
[ -f "${ROOT_DIR}/build/nook-webkey" ] && cp "${ROOT_DIR}/build/nook-webkey" "${STAGING_DIR}/opt/bin/nook-webkey"
[ -f "${ROOT_DIR}/build/send_key" ] && cp "${ROOT_DIR}/build/send_key" "${STAGING_DIR}/opt/bin/send_key"
